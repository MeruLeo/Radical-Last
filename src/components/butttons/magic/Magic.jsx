...
const MagicBtn = ({ title, autoCode }) => {
  ...
  return (
    <div className="mt-8">
      <div className="sp">
        <button className="sparkle-button" onClick={generateCode}>
        ...
        <div
          className={`bg-background-elm2 text-background-white rounded-full mt-4 flex justify-between items-center p-2`}
        >
          {code && (
            <button
              className="bg-background-elm rounded-lg p-2"
              onClick={copyToClipboard}
            >
              <i className="fi fi-tr-clone flex items-center justify-center"></i>
            </button>
          )}
